...
public class PathSumLarge {

	public static void run() {
		ArrayList<ArrayList<Integer>> tempPaths = readfromFile("problemsixtyseven.txt");
		...
		out.println("Problem 67: The sum of the maximum total from top to bottom is "
				+ paths[0][0]);

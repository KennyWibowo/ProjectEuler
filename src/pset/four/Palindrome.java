...
public class Palindrome {
	...
	public static void run(){
		...
		out.println("Number of palindromes: " + palindromes.size());
		out.println("Largest palindrome: " + getLargest(palindromes));
	}
	...
	private static String removeMid(String input){
		...
		String output = input.substring(0, input.length()/2) + input.substring((input.length()+1)/2, input.length()-1);
		return output;
	}
